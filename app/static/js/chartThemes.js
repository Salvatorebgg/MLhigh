...
const CHART_THEMES = {
  cnsTheme: {
    ...
    ink: '#111827',
    colorway: ['#2E6F9E', '#D95F59', '#2A9D8F', '#E9A93A', '#6F5AA7', '#7C8B52', '#C776A5', '#4A5568', '#8F6B43', '#5BA4CF'],
  ...
  clinicalTheme: {
    ...
    ink: '#142A2E',
    colorway: ['#0E7C7B', '#B34D3E', '#274C77', '#D59F32', '#665C9E', '#4D86B8', '#5F8D4E', '#C76E52', '#59788E', '#A5688F'],
  ...
  journalTheme: {
    ...
    ink: '#000000',
    colorway: ['#1B4F72', '#922B21', '#1E8449', '#B7950B', '#6C3483', '#1A5276', '#784212', '#17202A', '#4A235A', '#0E6655'],
  ...
  natureStyleTheme: {
    ...
    ink: '#111111',
    colorway: ['#3C5488', '#E64B35', '#00A087', '#4DBBD5', '#F39B7F', '#8491B4', '#91D1C2', '#7E6148', '#B09C85', '#DC0000'],
  ...
  lancetTheme: {
    ...
    ink: '#1a1a1a',
    colorway: ['#00468B', '#ED0000', '#42B540', '#0099B4', '#925E9F', '#FDAF91', '#AD002A', '#ADB6B6', '#1B1919', '#F0E685'],
  ...
  nejmTheme: {
    ...
    axisLineColor: '#1a1a1a',
    ink: '#1a1a1a',
    colorway: ['#BC3C29', '#0072B5', '#E18727', '#20854E', '#7876B1', '#6F99AD', '#FFDC91', '#EE4C97', '#8C564B', '#2CA02C'],
  ...
  scienceTheme: {
    ...
    axisLineColor: '#1a1a1a',
    ink: '#1a1a1a',
    colorway: ['#3B4992', '#EE0000', '#008B45', '#631879', '#008280', '#BB0021', '#5F559B', '#A20056', '#808180', '#1B195E'],
  ...
  warmTheme: {
    ...
    ink: '#3D2E1E',
    colorway: ['#C5741A', '#B34D3E', '#D59F32', '#8A5A30', '#E08050', '#A05040', '#C09050', '#906040', '#D4A574', '#7A4420'],
  ...
  coolTheme: {
    ...
    ink: '#1a2a40',
    colorway: ['#2E5090', '#4A90D9', '#1B7A8A', '#6B8FB5', '#3A6B9F', '#5BAEB5', '#2D6B7F', '#7AAFC8', '#1F4E6F', '#4ECDC4'],
  ...
  pastelTheme: {
    ...
    ink: '#3a3a3a',
    colorway: ['#8DD3C7', '#FFFFB3', '#BEBADA', '#FB8072', '#80B1D3', '#FDB462', '#B3DE69', '#FCCDE5', '#D9D9D9', '#BC80BD'],
  ...
  darkMutedTheme: {
    ...
    ink: '#E0E4E8',
    colorway: ['#8AC6B4', '#D08070', '#6090B8', '#D0A850', '#9888B8', '#68A0C8', '#78B098', '#D09078', '#7898B0', '#B88898'],
  ...
  monoTheme: {
    ...
    axisLineColor: '#1a1a1a',
    ink: '#1a1a1a',
    colorway: ['#1a1a1a', '#4a4a4a', '#7a7a7a', '#a0a0a0', '#c0c0c0', '#3a3a3a', '#5a5a5a', '#8a8a8a', '#b0b0b0', '#d0d0d0'],
